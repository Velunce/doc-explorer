 ...
 * LoginPage
 *
 * A React component for user registration. It includes a form for collecting user details
 * (email, password, first name, and last name) and submits the data to the server.
 *
 * Features:
 * - Clears localStorage on component mount.
 * - Submits user data to the `/api/user` endpoint.
